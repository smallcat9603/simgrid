# modified by smallcat 211207, add new objective (simulated time) for simgrid use
# modified by smallcat 220623, add new objective (FLOPS) for HPL, HPCG (Kashiwa FPGA)
