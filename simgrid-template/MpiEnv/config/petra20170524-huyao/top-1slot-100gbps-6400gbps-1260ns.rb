...
def main
 ...
 # bench_range=BENCHLOCKNAME.keys
  ...
  commonOpts[:cablebw]=6400e9   #huyao170612    #The bandwidth of cable in bit/s
  commonOpts[:switchlat]=1260e-9  #huyao170605   #The latency of switches in seconds
  ...
  nswitches_range.each{ |nswitches|
    ...
    opts[:resultfile]="result_#{nswitches}_1slot_100gbps_6400gbps_1260ns" #huyao170614
 ...
 #,{:headers=>true}
  ...
  tables.each{ |nswitches,table| 
    FileUtils.rm_rf  "2result_#{nswitches}_1slot_100gbps_6400gbps_1260ns.csv" #huyao170614
    sleep(1)
    File.write("2result_#{nswitches}_1slot_100gbps_6400gbps_1260ns.csv",table.to_csv({:col_sep=>"\t;"}))  #huyao170614
  }
end
