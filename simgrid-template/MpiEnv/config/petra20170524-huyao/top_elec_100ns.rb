...
def main
 ...
 # bench_range=BENCHLOCKNAME.keys
  ...
  commonOpts[:cablebw]=400e9  #huyao170613      #The bandwidth of cable in bit/s
  commonOpts[:switchlat]=100e-9  #huyao170613   #The latency of switches in seconds
  ...
  nswitches_range.each{ |nswitches|
    ...
    opts[:resultfile]="result_#{nswitches}_elec_100ns" #huyao170613
	...
	topology_range=["3torus-4-4-4-400Gbps", "3torus-4-4-4-1Tbps", "petra-elec_fullyconnected"]
 ...
 #,{:headers=>true}
  ...
  tables.each{ |nswitches,table| 
    FileUtils.rm_rf  "2result_#{nswitches}_elec_100ns.csv" #huyao170613
    sleep(1)
    File.write("2result_#{nswitches}_elec_100ns.csv",table.to_csv({:col_sep=>"\t;"}))  #huyao170613
  }
end
