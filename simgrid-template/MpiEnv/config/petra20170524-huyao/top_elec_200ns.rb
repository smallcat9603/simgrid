...
def main
 ...
 # bench_range=BENCHLOCKNAME.keys
  ...
  commonOpts[:switchlat]=200e-9  #huyao170621   #The latency of switches in seconds
  ...
  nswitches_range.each{ |nswitches|
    ...
    opts[:resultfile]="result_#{nswitches}_elec_200ns" #huyao170621
 ...
 #,{:headers=>true}
  ...
  tables.each{ |nswitches,table| 
    FileUtils.rm_rf  "2result_#{nswitches}_elec_200ns.csv" #huyao170621
    sleep(1)
    File.write("2result_#{nswitches}_elec_200ns.csv",table.to_csv({:col_sep=>"\t;"}))  #huyao170621
  }
end
