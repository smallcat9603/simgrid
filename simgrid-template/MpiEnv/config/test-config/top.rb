...
def main
  ...
  commonOpts[:maxprocesses]=20    #Number of concurrent simulations to run
  ...
  bench_range=["graph500"]#,"mg" 
  #bench_range=["bt","cg","dt","ep","ft","is","lu","sp"]#,"mg" 
  case ARGV[2]
  when "0"
   bench_range=["is"]
  ...
  nswitches_range.each{ |nswitches|
   ...
   #topology_range=["out_64_4"]
   topology_range=["3torus-4-4-4", "augment_d6_64-bFalse", "random_d6_64-bTrue", "Ito_d6_64-bFalse","random_d6_64-bFalse","reduced_d6_64-bTrue"]
