...
int main(int argc, char *argv[]) {
  ...
  /* SGU: BEGIN SUITES DECLARATION */
    ...
    /* SGU: BEGIN FILE xbt/dict.c */
      ...
      xbt_test_suite_push(suite, "basic_heterogeneous",  test_dict_basic_heterogeneous,  "Basic usage: change, retrieve, traverse: heterogeneous dict");
      xbt_test_suite_push(suite, "basic_homogeneous",  test_dict_basic_homogeneous,  "Basic usage: change, retrieve, traverse: homogeneous dict");
      xbt_test_suite_push(suite, "remove_heterogeneous",  test_dict_remove_heterogeneous,  "Removing some values: heterogeneous dict");
      xbt_test_suite_push(suite, "remove_homogeneous",  test_dict_remove_homogeneous,  "Removing some values: homogeneous dict");
    ...
    /* SGU: BEGIN FILE xbt/xbt_str.c */
      ...
      xbt_test_suite_push(suite, "xbt_str_diff",  test_diff,  "test the function xbt_str_diff");
    /* SGU: END FILE */
