...
CXX_SRC_F = []
CXX_TGT_F = ['-c', '-o']
DATADIR = '/opt/ns3.32/share'
DATAROOTDIR = '/opt/ns3.32/share'
...
DEST_CPU = 'aarch64'
DEST_OS = 'linux'
DOCDIR = '/opt/ns3.32/share/doc/ns'
DOXYGEN = ['/usr/bin/doxygen']
DVIDIR = '/opt/ns3.32/share/doc/ns'
ENABLE_BRITE = False
...
HAVE_SYS_TYPES_H = 1
HAVE___UINT128_T = 1
HTMLDIR = '/opt/ns3.32/share/doc/ns'
INCLUDEDIR = '/opt/ns3.32/include'
INCLUDES_BOOST = '/usr/include'
INFODIR = '/opt/ns3.32/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/opt/ns3.32/lib'
LIBEXECDIR = '/opt/ns3.32/libexec'
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
LOCALEDIR = '/opt/ns3.32/share/locale'
LOCALSTATEDIR = '/opt/ns3.32/var'
MANDIR = '/opt/ns3.32/share/man'
...
NS3_EXECUTABLE_PATH = ['/github/simgrid/ns-allinone-3.32/ns-3.32/build/src/fd-net-device', '/github/simgrid/ns-allinone-3.32/ns-3.32/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/aarch64-linux-gnu/9', '/github/simgrid/ns-allinone-3.32/ns-3.32/build/lib', '/github/simgrid/ns-allinone-3.32/ns-3.32/build']
...
PACKAGE = 'ns'
PDFDIR = '/opt/ns3.32/share/doc/ns'
PLATFORM = 'linux'
PREFIX = '/opt/ns3.32'
PRINT_BUILT_MODULES_AT_END = False
PSDIR = '/opt/ns3.32/share/doc/ns'
PYC = 1
PYFLAGS = ''
PYFLAGS_OPT = '-O'
PYO = 1
...
RPATH_ST = '-Wl,-rpath,%s'
SBINDIR = '/opt/ns3.32/sbin'
SEMAPHORE_ENABLED = True
SHAREDSTATEDIR = '/opt/ns3.32/com'
...
STLIB_ST = '-l%s'
SUDO = ['/usr/bin/sudo']
SYSCONFDIR = '/opt/ns3.32/etc'
VALGRIND_FOUND = False
VERSION = '3.32'
WL_SONAME_SUPPORTED = True
cfg_files = ['/github/simgrid/ns-allinone-3.32/ns-3.32/build/ns3/config-store-config.h', '/github/simgrid/ns-allinone-3.32/ns-3.32/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
