...
teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.o: ../teshsuite/s4u/host-on-off-actors/host-on-off-actors.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/github/simgrid/simgrid-3.26/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.o"
	cd /github/simgrid/simgrid-3.26/build/teshsuite/s4u && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.o -c /github/simgrid/simgrid-3.26/teshsuite/s4u/host-on-off-actors/host-on-off-actors.cpp
...
teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.i: cmake_force
	...
	cd /github/simgrid/simgrid-3.26/build/teshsuite/s4u && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /github/simgrid/simgrid-3.26/teshsuite/s4u/host-on-off-actors/host-on-off-actors.cpp > CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.i
...
teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.s: cmake_force
	...
	cd /github/simgrid/simgrid-3.26/build/teshsuite/s4u && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /github/simgrid/simgrid-3.26/teshsuite/s4u/host-on-off-actors/host-on-off-actors.cpp -o CMakeFiles/host-on-off-actors.dir/host-on-off-actors/host-on-off-actors.cpp.s
...
teshsuite/s4u/host-on-off-actors/host-on-off-actors: lib/libsimgrid.so.3.26
teshsuite/s4u/host-on-off-actors/host-on-off-actors: /usr/lib/aarch64-linux-gnu/libboost_context.so.1.71.0
teshsuite/s4u/host-on-off-actors/host-on-off-actors: teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/github/simgrid/simgrid-3.26/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable host-on-off-actors/host-on-off-actors"
	cd /github/simgrid/simgrid-3.26/build/teshsuite/s4u && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/host-on-off-actors.dir/link.txt --verbose=$(VERBOSE)
...
teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/clean:
	cd /github/simgrid/simgrid-3.26/build/teshsuite/s4u && $(CMAKE_COMMAND) -P CMakeFiles/host-on-off-actors.dir/cmake_clean.cmake
.PHONY : teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/clean

teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/depend:
	cd /github/simgrid/simgrid-3.26/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /github/simgrid/simgrid-3.26 /github/simgrid/simgrid-3.26/teshsuite/s4u /github/simgrid/simgrid-3.26/build /github/simgrid/simgrid-3.26/build/teshsuite/s4u /github/simgrid/simgrid-3.26/build/teshsuite/s4u/CMakeFiles/host-on-off-actors.dir/DependInfo.cmake --color=$(COLOR)
